...
namespace TheOne.Persistence.Migrations
{
    ...
    [Migration("20260910100612_AddAdministrationAndAudit")]
    partial class AddAdministrationAndAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheOne.Domain.Entities.NavigationMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TheOne.Domain.Entities.NavigationMenuRole", b =>
                {
            ...
            modelBuilder.Entity("TheOne.Domain.Entities.SecurityAuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TheOne.Domain.Entities.NavigationMenu", b =>
                {
                    b.HasOne("TheOne.Domain.Entities.NavigationMenu", null)
                        .WithMany()
